...
public class CodeGenerateUtils {
	...
	public void generate(String tableName, String modelName, String tableAnnotation, String author) throws Exception {
		...
		try {
			...
			// 生成Controller文件
			generateControllerFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成listHtml文件
			generateListHtmlFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成AddHtml文件
			generateAddHtmlFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成EditHtml文件
			generateEditHtmlFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成DetailsHtml文件
			generateDetailsHtmlFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成listJs文件
			generateListJsFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成AddJs文件
			generateAddJsFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成EditJs文件
			generateEditJsFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
	...
	private void generateEntityFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
		...
		if (!createPath.exists()) {// 避免生成覆盖
			...
			Map<String, Object> dataMap = dataMap(modelName, Constant.ENTITY_PACKAGE, hasDateType, databaseMetaData.getColumns(null, null, tableName, "%"),
					table_key, table_key_change, table_key_type);
	...
	private void generateDtoFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		...
		if (!createPath.exists()) {// 避免生成覆盖
			...
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.DTO_PACKAGE, hasDateType, databaseMetaData.getColumns(null, null, tableName, "%"),
					table_key, table_key_change, table_key_type);
			generateFileByTemplate(templateName, mapperFile, dataMap, tableName, modelName, tableAnnotation, author);
		} else {
			System.out.println("文件已存在,如需重新生成请手动删除现存文件再次执行！" + path);
	...
	private void generateDaoFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		...
		if (!createPath.exists()) {// 避免生成覆盖
			...
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.DAO_PACKAGE, "", databaseMetaData.getColumns(null, null, tableName, "%"), table_key,
					table_key_change, table_key_type);
			generateFileByTemplate(templateName, mapperFile, dataMap, tableName, modelName, tableAnnotation, author);
		} else {
			System.out.println("文件已存在,如需重新生成请手动删除现存文件再次执行！" + path);
		}
	...
	private void generateDaoImplFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		...
		if (!createPath.exists()) {// 避免生成覆盖
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.DAO_IMPL_PACKAGE, "", databaseMetaData.getColumns(null, null, tableName, "%"), table_key,
					camelName(table_key), table_key_type);
			if (Constant.URL.contains("oracle")) {
	...
	private void generateServiceFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		...
		if (!createPath.exists()) {// 避免生成覆盖
			...
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.SERVICE_PACKAGE, "", databaseMetaData.getColumns(null, null, tableName, "%"), table_key,
					camelName(table_key), table_key_type);
			generateFileByTemplate(templateName, mapperFile, dataMap, tableName, modelName, tableAnnotation, author);
		} else {
			System.out.println("文件已存在,如需重新生成请手动删除现存文件再次执行！" + path);
	...
	private void generateServiceImplFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
		...
		if (!createPath.exists()) {// 避免生成覆盖
			...
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.SERVICE_IMPL_PACKAGE, "", databaseMetaData.getColumns(null, null, tableName, "%"),
					table_key, camelName(table_key), table_key_type);
			generateFileByTemplate(templateName, mapperFile, dataMap, tableName, modelName, tableAnnotation, author);
		} else {
			System.out.println("文件已存在,如需重新生成请手动删除现存文件再次执行！" + path);
		}
	...
	private void generateApiFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		...
		if (!createPath.exists()) {// 避免生成覆盖
			...
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.API_PACKAGE, "", databaseMetaData.getColumns(null, null, tableName, "%"), table_key,
					camelName(table_key), table_key_type);
			generateFileByTemplate(templateName, mapperFile, dataMap, tableName, modelName, tableAnnotation, author);
		} else {
			System.out.println("文件已存在,如需重新生成请手动删除现存文件再次执行！" + path);
	...
	private void generateControllerFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.PACKAGE_PATH_CONTROLLER));
		final String path = Constant.PACKAGE_PATH_CONTROLLER + modelName + "Controller.java";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
			final String templateName = "Controller.ftl";
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.CONTROLLER_PACKAGE, "", databaseMetaData.getColumns(null, null, tableName, "%"),
					table_key, camelName(table_key), table_key_type);
			generateFileByTemplate(templateName, mapperFile, dataMap, tableName, modelName, tableAnnotation, author);
		} else {
			System.out.println("文件已存在,如需重新生成请手动删除现存文件再次执行！" + path);
	...
	private void generateListHtmlFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.htmlPath + modelName + "//"));
		final String path = Constant.htmlPath + modelName + "//" + modelName + "_" + "list.html";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
			final String templateName = "ListHtml.ftl";
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.htmlPath, "", databaseMetaData.getColumns(null, null, tableName, "%"), table_key,
					camelName(table_key), table_key_type);
			generateFileByTemplate(templateName, mapperFile, dataMap, tableName, modelName, tableAnnotation, author);
		} else {
			System.out.println("文件已存在,如需重新生成请手动删除现存文件再次执行！" + path);
	...
	private void generateAddHtmlFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.htmlPath + modelName + "//"));
		final String path = Constant.htmlPath + modelName + "//" + modelName + "_" + "add.html";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateEditHtmlFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.htmlPath + modelName + "//"));
		final String path = Constant.htmlPath + modelName + "//" + modelName + "_" + "edit.html";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateDetailsHtmlFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.htmlPath + modelName + "//"));
		final String path = Constant.htmlPath + modelName + "//" + modelName + "_" + "details.html";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateListJsFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.jsPath + modelName + "//"));
		final String path = Constant.htmlPath + modelName + "//" + modelName + "_" + "list.js";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
			final String templateName = "ListJs.ftl";
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.jsPath, "", databaseMetaData.getColumns(null, null, tableName, "%"), table_key,
					camelName(table_key), table_key_type);
			generateFileByTemplate(templateName, mapperFile, dataMap, tableName, modelName, tableAnnotation, author);
		} else {
			System.out.println("文件已存在,如需重新生成请手动删除现存文件再次执行！" + path);
	...
	private void generateAddJsFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.jsPath + modelName + "//"));
		final String path = Constant.htmlPath + modelName + "//" + modelName + "_" + "add.js";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateEditJsFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.jsPath + modelName + "//"));
		final String path = Constant.htmlPath + modelName + "//" + modelName + "_" + "edit.js";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
