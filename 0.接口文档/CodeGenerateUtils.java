...
//		return connection;
	...
	public void generate(String tableName, String modelName, String tableAnnotation, String author) throws Exception {
		...
		try {
			...
			// 生成接口文档文件
			generateInterfaceFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}

	private void generateInterfaceFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.INTERFACE_PATH));
		String hasDateType = "false";
		final String path = Constant.INTERFACE_PATH + modelName + "Interface" + ".xml";
	...
	private void generateFileByTemplate(final String templateName, File file, Map<String, Object> dataMap, String tableName, String modelName,
		...
		dataMap.put("modelNameLowerCase", modelName.toLowerCase());
