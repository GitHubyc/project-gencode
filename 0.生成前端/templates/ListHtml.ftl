                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <div class="col-lg-8  col-md-8 col-sm-8 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12"
                                                   name="${modelName?uncap_first}Name" placeholder="请输入名称">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <ul class="list_table">
                                    <table class="table table-hover text-center">
                                        ...
                                        <tr th:each="${modelName?uncap_first} : ${r"$"}{object.data}">
                                            <td style="display:none" th:text="${r"$"}{${modelName?uncap_first}.${modelName?uncap_first}Id}"></td>
                                            <td>
                                                <img class="list_icon" style="height:50px;width:30.9px;"
                                                     th:src="${r"$"}{${modelName?uncap_first}.${modelName?uncap_first}Img}==null?'../img/noimage.png':'../img/noimage.png'">
                                                <img class="img_show"
                                                     th:src="${r"$"}{${modelName?uncap_first}.${modelName?uncap_first}Img}==null?'../img/noimage.png':'../img/noimage.png'"
                                            ...
                                            <td>
                                                <a href="javascript:(0)" class="${modelName}_details"
                                                   th:text="${r"$"}{${modelName?uncap_first}.${modelName?uncap_first}Name}" th:id="${r"$"}{${modelName?uncap_first}.${modelName?uncap_first}Id}"></a>
                                            </td>
                                            <#list model_column?keys as key>
                                             <td th:text="${r"${"}${modelName?uncap_first}.${model_column[key].ChangeColumnName}}"></td>
                                            </#list>
                                            <td><a class="details"><i class="fa fa-sign-in"></i><div style="display:none" th:text="${r"$"}{${modelName?uncap_first}.${modelName?uncap_first}Details}"></div></a></td>
                                            <td>
