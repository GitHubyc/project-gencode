...
public class CodeGenerateUtils {
	...
	public void generate(String tableName, String modelName, String tableAnnotation, String author) throws Exception {
		...
		try {
			...
			// 生成AddDto文件
			generateAddDtoFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成PutDto文件
			generatePutDtoFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成DetailOutputDto文件
			generateDetailOutputDtoFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成ListInputDto文件
			generateListInputDtoFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成ListOutputDto文件
			generateListOutputDtoFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			if (has_primary)
			...
			// 生成DelDto文件
			generateDelDtoFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
			// 生成DetailInputDto文件
			generateDetailInputDtoFile(databaseMetaData, table_key, table_key_change, table_key_type, tableName, modelName, tableAnnotation, author);
		} catch (Exception e) {
	...
	private void generateAddDtoFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.PACKAGE_PATH_DTO));
		String hasDateType = "false";
		final String path = Constant.PACKAGE_PATH_DTO + "Add" + modelName + "InputDto" + ".java";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateDelDtoFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.PACKAGE_PATH_DTO));
		String hasDateType = "false";
		final String path = Constant.PACKAGE_PATH_DTO + "Del" + modelName + "InputDto" + ".java";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generatePutDtoFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.PACKAGE_PATH_DTO));
		String hasDateType = "false";
		final String path = Constant.PACKAGE_PATH_DTO + "Put" + modelName + "InputDto" + ".java";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateDetailInputDtoFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.PACKAGE_PATH_DTO));
		String hasDateType = "false";
		final String path = Constant.PACKAGE_PATH_DTO + modelName + "DetailInputDto" + ".java";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateDetailOutputDtoFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.PACKAGE_PATH_DTO));
		String hasDateType = "false";
		final String path = Constant.PACKAGE_PATH_DTO + modelName + "DetailOutputDto" + ".java";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateListInputDtoFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.PACKAGE_PATH_DTO));
		String hasDateType = "false";
		final String path = Constant.PACKAGE_PATH_DTO + modelName + "ListInputDto" + ".java";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateListOutputDtoFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
			String modelName, String tableAnnotation, String author) throws Exception {
		mkdirs(new File(Constant.PACKAGE_PATH_DTO));
		String hasDateType = "false";
		final String path = Constant.PACKAGE_PATH_DTO + modelName + "ListOutputDto" + ".java";
		File createPath = new File(path);
		if (!createPath.exists()) {// 避免生成覆盖
	...
	private void generateControllerFile(DatabaseMetaData databaseMetaData, String table_key, String table_key_change, String table_key_type, String tableName,
		...
		if (!createPath.exists()) {// 避免生成覆盖
			...
			File mapperFile = new File(path);
			Map<String, Object> dataMap = dataMap(modelName, Constant.CONTROLLER_PACKAGE, "", databaseMetaData.getColumns(null, null, tableName, "%"), table_key,
					camelName(table_key), table_key_type);
			generateFileByTemplate(templateName, mapperFile, dataMap, tableName, modelName, tableAnnotation, author);
		} else {
			System.out.println("文件已存在,如需重新生成请手动删除现存文件再次执行！" + path);
